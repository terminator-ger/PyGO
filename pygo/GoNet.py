...
class GoNet(th.nn.Module):
    def __init__(self, num_classes=3):
        ...
        self.block0 = ResBlock( 16,  64, stride=2)        
        self.block1 = ResBlock( 64,  64, stride=1, dilation=1)        
        self.block2 = ResBlock( 64, 128, stride=2)        
        self.block3 = ResBlock(128, 128, stride=1, dilation=1)        
        self.block4 = ResBlock(128, 256, stride=2)        
        self.block5 = ResBlock(256, 256, stride=1, dilation=1)        
