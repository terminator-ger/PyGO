...
import cv2 
import pdb
from utils.image import toCMYKImage, toByteImage, toGrayImage, toColorImage, toHSVImage
import numpy as np
...
class window:
    def __init__(self, img):
        ...
        self.params.minCircularity = 0.78
...
cv2.createTrackbar('c', title_window , 103, 200, win.update_c)
...
win.update_min_circ(82)
win.update_max_circ(100)
win.update_min_area(200)
win.update_max_area(300)
win.update_min_conv(95)
win.update_max_conv(100)
win.update_min_inert(50)
win.update_max_inert(100)
#win.update_ks(63)
#win.update_ks_filter(10)
#win.update_c(103)
#win.update_min_radius(20)
